...
REM Check if Python is available (should be JARVIS environment)
echo [1/6] Checking Python availability in JARVIS environment...
...
if %errorlevel% neq 0 (
    ...
    python --version
    echo Checking if we're in JARVIS environment...
...
REM Test CUDA with Python in JARVIS environment
echo [4/6] Testing CUDA with Python in JARVIS environment...
